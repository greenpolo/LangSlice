/** App-shell header. Browser demo: API Keys + Local Models + Chat + dashboard
 *  nav. Load Demo Brain lives in the dashboard atlas bar — not here. */
    ...
    <>
      <header className="app-header">
        ...
        <button
          ...
          onClick={openApiKeys}
          title="Set Gemini API key (used for image-gen registration)"
        >
          API Keys
        </button>
        <button
          ...
          title="Configure the local Gemma 4 LiteRT-LM sidecar"
        >
          Local Models
        </button>
        <button
