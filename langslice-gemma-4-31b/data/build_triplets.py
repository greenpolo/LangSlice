...
Usage:
    python -m langslice_gemma_4_31b.data.build_triplets \
        --atlas-slices langslice-gemma-4-31b/data/atlas_slices \
        --output langslice-gemma-4-31b/data/triplets.jsonl
"""
