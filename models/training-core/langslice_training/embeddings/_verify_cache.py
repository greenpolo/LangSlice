...
Run via the Docker training service::
    ...
    python -m langslice_training.embeddings._verify_cache \\
...
from langslice_training.embeddings.precompute import _encode_pil, _load_model_and_processor
from langslice_training.rl.common.atlas_grid import Plane, canonicalize_atlas_name
