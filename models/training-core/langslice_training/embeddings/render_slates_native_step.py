...
slate that ``langslice_training.embeddings.precompute`` can then walk to build a 100%-cache-hit
...
Usage::
    ...
    python -m langslice_training.embeddings.render_slates_native_step \\
