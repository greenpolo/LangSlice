...
These helpers are canonical shared utilities in training-core after
expert-iteration retirement.
"""
    ...
    for idx, event in enumerate(events):
        ...
        for tool_call in event.get("tool_calls") or []:
            ...
            if name == "fetch_atlas":
                ...
                trace.append(
                    {
                        "tool_call": {"name": "fetch_atlas", "args": {"positions_mm": positions}},
                        "tool_result": {
...
def trim_trace(
    ...
    *,
    ...
    return _trim_trace(trace, max_fetch_calls=max_fetch_calls, max_total_images=max_total_images)
