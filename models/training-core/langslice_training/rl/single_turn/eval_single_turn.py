...
::
    ...
    PYTHONPATH=models/training-core \\
    python -m langslice_training.rl.single_turn.eval_single_turn \\
        --model out/rlvr_single_turn/terminal_smoke \\
        --sft-model out/sft/docker-sft-1011-merged-bf16 \\
        --eval-states out/rl_single_turn/terminal_eval.jsonl \\
...
from langslice_training.rl.common.train_grpo_helpers import _adapter_base_model_name
...
def _build_chat_for_inference(state: TerminalState) -> list[dict[str, Any]]:
    ...
    from langslice_training.rl.common.dataset import species_from_atlas_name  # noqa: PLC0415
