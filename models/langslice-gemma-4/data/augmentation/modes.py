...
class ISHMode:
    ...
    name: str
    weight: float
    counterstain: str  # key into COUNTERSTAIN_REGISTRY: "none" | "nfr" | "hematoxylin" | "dapi" | "nissl"
...
class FluorescenceMode:
    ...
    name: str
    weight: float
    counterstain: str  # "dapi" | "nissl" | "none"  (NeuroTrace is rendered like Nissl with cooler palette)
...
_GFP_LIKE_MODERATE = IFChannelSpec(
    name="gfp_moderate", channel=1, distribution="moderate",
    density_range_per_mm2=(150.0, 600.0), intensity_range=(0.55, 0.95),
    sigma_range_scale=(0.7, 1.5),
)
_TDTOM_LIKE_MODERATE = IFChannelSpec(
    name="tdtom_moderate", channel=0, distribution="moderate",
    density_range_per_mm2=(120.0, 500.0), intensity_range=(0.60, 0.95),
    sigma_range_scale=(0.7, 1.5),
)
_PV_SPARSE_RED = IFChannelSpec(
    name="pv_sparse_red", channel=0, distribution="sparse",
    density_range_per_mm2=(30.0, 100.0), intensity_range=(0.65, 0.95),
    sigma_range_scale=(0.6, 1.3),
)
_SOM_SPARSE_GREEN = IFChannelSpec(
    name="som_sparse_green", channel=1, distribution="sparse",
    density_range_per_mm2=(25.0, 90.0), intensity_range=(0.60, 0.95),
    sigma_range_scale=(0.6, 1.3),
)
_VIP_SPARSE_RED = IFChannelSpec(
    name="vip_sparse_red", channel=0, distribution="sparse",
    density_range_per_mm2=(20.0, 80.0), intensity_range=(0.60, 0.90),
    sigma_range_scale=(0.6, 1.2),
)
_NEUN_PAN_GREEN = IFChannelSpec(
    name="neun_pan_green", channel=1, distribution="moderate",
    density_range_per_mm2=(800.0, 2000.0), intensity_range=(0.45, 0.85),
    sigma_range_scale=(0.5, 1.0),
)
_GFAP_SPARSE_RED = IFChannelSpec(
    name="gfap_sparse_red", channel=0, distribution="scattered",
    density_range_per_mm2=(80.0, 250.0), intensity_range=(0.40, 0.80),
    sigma_range_scale=(0.6, 1.4),
)
_IBA1_SCATTERED = IFChannelSpec(
    name="iba1_scattered", channel=0, distribution="scattered",
    density_range_per_mm2=(60.0, 180.0), intensity_range=(0.50, 0.85),
    sigma_range_scale=(0.6, 1.3),
)
_CFOS_SCATTERED_GREEN = IFChannelSpec(
    name="cfos_scattered_green", channel=1, distribution="scattered",
    density_range_per_mm2=(20.0, 200.0), intensity_range=(0.55, 0.95),
    sigma_range_scale=(0.5, 1.1),
)
_AAV_GFP_TRACT_SPARSE = IFChannelSpec(
    name="aav_gfp_tract_sparse", channel=1, distribution="tract_sparse",
    density_range_per_mm2=(15.0, 80.0), intensity_range=(0.70, 1.00),
    sigma_range_scale=(0.7, 1.5),
)
_AAV_TDTOM_TRACT_SPARSE = IFChannelSpec(
    name="aav_tdtom_tract_sparse", channel=0, distribution="tract_sparse",
    density_range_per_mm2=(15.0, 80.0), intensity_range=(0.70, 1.00),
    sigma_range_scale=(0.7, 1.5),
)
