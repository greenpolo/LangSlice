...
::
    ...
    # From repo root via the langslice-single-turn-rl launcher. Default mode is
...
def main(argv: list[str] | None = None) -> None:
    ...
    # ``langslice-single-turn-rl`` launcher (which does NOT reach the
    ...
    if args.query_embedding_cache is not None:
        from embeddings.query_cache import QueryEmbeddingCache  # noqa: PLC0415
