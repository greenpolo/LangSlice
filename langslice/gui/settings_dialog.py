...
from langslice.gui.theme import BG_PRIMARY, TEXT_SECONDARY
...
class SettingsDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        form.addRow("VLM Provider:", self.provider_combo)
        ...
        form.addRow("Vertex API Key:", self.vertex_key)
    ...
    def _on_provider_changed(self) -> None:
        ...
        if provider == _BACKEND_AI_STUDIO:
            ...
            self.info_label.setText("Uses the Google AI Studio free tier. Requires a Gemini API Key.")
