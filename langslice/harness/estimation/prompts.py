...
def build_single_slice_prompt(
    *,
    ...
    return (
        ...
        f"5. Fine-tune by fetching very fine neighboring atlas positions and "
        f"comparing their landmarks against the target.\n"
...
def build_group_prompt(
    *,
    ...
    return (
        ...
        f"nearby atlas sections. Use finer `fetch_atlas` calls for direct "
        f"visual comparison.\n"
