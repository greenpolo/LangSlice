...
from langslice_harness.agent_trace import (
    image_part_from_pil,
    json_part,
    model_event,
    runtime_event,
...
from langslice_harness.retry import (
    format_elapsed_seconds as _format_elapsed_seconds,
)
from langslice_harness.retry import (
    retry_with_backoff,
)
from langslice_harness.vlm_config import get_client
...
def _species_from_atlas_name(atlas_name: str) -> str:
    from langslice_harness.atlas.core import species_from_atlas_name
