"""Debug artifact writing for AP estimation runs."""
...
if TYPE_CHECKING:
    from langslice_harness.estimation._shared_common import _APLoopState
    ...
    *,
    ...
    with open(reasoning_path, "w", encoding="utf-8") as f:
        ...
        for turn in state.turn_metrics:
            ...
            usage = cast(dict[str, int | float | str | bool], turn.get("usage_metadata", {}))
            preflight = cast(
            ...
            for content in history:
                ...
                for part in content_parts:
                    ...
                    if part.function_call:
                        ...
                        f.write(f"  CALL: {fc.name}({fc_args})\n")
                    if part.function_response:
                        fr = part.function_response
                        f.write(f"  RESPONSE: {fr.name} -> {fr.response}\n")
                    if part.inline_data:
